...
async function LeasesPageInner({ params }: LeasesPageProps) {
  ...
  return (
    <>
      <TeamAccountLayoutPageHeader account={slug} title="Sales & lettings" />
...
export const LeasesPage = withI18n(LeasesPageInner);
