        ...
        return (
          <section key={group.id} className="mb-1">
            <button
              ...
              className="sticky top-0 z-10 flex w-full items-center gap-2 border-b border-white/8 bg-[var(--workspace-shell-canvas)] px-4 py-2.5 text-left md:px-5"
                ...
                <table className="w-full min-w-[960px] border-collapse text-sm">
                  ...
                  <tbody>
                        ...
                        >
                          <td className="px-4 py-1.5 md:px-5">
                            <Link
                              ...
                              className="flex items-center gap-2 font-medium text-white hover:text-[#579bfc]"
                            >
                              <span className="inline-flex h-5 w-5 shrink-0 items-center justify-center rounded-full border border-white/15 text-[10px] text-zinc-500 opacity-0 transition-opacity group-hover:opacity-100">
                                +
                              </span>
                              {job.title}
                            </Link>
                          ...
                          <td className="px-2 py-1.5">
                            {member ? (
                              ...
                              <span className="inline-flex h-7 w-7 items-center justify-center rounded-full bg-zinc-700 text-[10px] text-zinc-300">
                          ...
                          <td className="px-2 py-1.5">
                            <span className="inline-flex rounded-md bg-zinc-800/80 px-2 py-1 text-xs text-zinc-300">
                              {formatTimelineRange(
                                job.start_date,
                                job.due_date,
                              )}
                          ...
                          <td className="px-2 py-1.5 md:pr-5">
                            <Link
                              href={jobDetailPath.replace('[id]', job.id)}
                              className="inline-flex h-7 w-7 items-center justify-center rounded text-zinc-500 opacity-0 transition-opacity hover:bg-white/5 hover:text-white group-hover:opacity-100"
                      ...
                      <tr className="border-b border-white/4">
                        ...
                        >
                          <button
                            ...
                            className="inline-flex items-center gap-1.5 text-xs font-medium text-zinc-500 transition-colors hover:text-[#579bfc]"
                          >
                    ...
                    <tr className="bg-white/[0.02]">
                      <td className="px-4 py-2 text-xs text-zinc-500 md:px-5">
                        Summary
                      </td>
                      <td />
                      <td />
        ...
        <div className="flex min-h-[280px] flex-col items-center justify-center gap-3 px-6 text-center">
          ...
          {canEditJobs && (
            <button
              type="button"
              onClick={onAddProject}
              className="inline-flex h-9 items-center gap-1.5 rounded-md bg-[#0073ea] px-4 text-sm font-semibold text-white hover:bg-[#0060c2]"
            >
