...
| +50,000 sends (Scale) | £24 (`…_SEND_50K_SCALE`) | £20 (`…_50K_SCALE_MONTHLY`) | `keel.campaigns.pack.send_50k_scale` / `.monthly` |
...
STRIPE_PRICE_CAMPAIGNS_PACK_SEND_50K_SCALE=price_...
STRIPE_PRICE_CAMPAIGNS_PACK_SEND_50K_SCALE_MONTHLY=price_...
