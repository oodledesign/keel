...
export function JobProjectTaskSheet({
  ...
  onSubtaskCreated?: (subtask: JobBoardTask) => void;
                ...
                {canEditJobs ? (
                  <form
                    ...
                    onSubmit={(e) => {
                      ...
                      startTransition(async () => {
                        try {
                          const created = await createJobTask({
                            accountId,
                            accountSlug,
                            jobId,
                  ...
                  >
                    ...
                    <Button
                      ...
                      size="sm"
                      variant="ghost"
                      disabled={pending || !newSubtaskTitle.trim()}
      ...
      <AlertDialog open={deleteOpen} onOpenChange={setDeleteOpen}>
        <AlertDialogContent className="border-[color:var(--workspace-shell-border)] bg-[var(--workspace-shell-panel)] text-[var(--workspace-shell-text)]">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {subtasks.length > 0
                ? `This will also delete ${subtasks.length} subtask${subtasks.length === 1 ? '' : 's'}. This can’t be undone.`
