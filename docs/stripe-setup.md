...
The catalog script includes **Ozer Campaigns** plus send packs and contact-cap bumps. Amounts match `apps/web/lib/billing/campaign-pricing.ts` and env keys in `stripe-price-ids.ts` / `billing.config.ts`. Campaigns is monthly-only (no yearly prices). Send packs and contact bumps stack — buying another pack raises the entitlement; it does not replace the previous one.
...
| Scale | £149 / mo · 30,000 · 360,000 | `STRIPE_PRICE_ADDON_CAMPAIGNS_SCALE_MONTHLY` | `keel.addon.campaigns.scale.monthly` |
...
| +200,000 sends | £79 (`…_SEND_200K`) | £69 (`…_200K_MONTHLY`) | `keel.campaigns.pack.send_200k` / `.monthly` |
| +500,000 sends | £179 (`…_SEND_500K`) | £149 (`…_500K_MONTHLY`) | `keel.campaigns.pack.send_500k` / `.monthly` |
...
| +2,000 contacts | £8 / mo | `STRIPE_PRICE_CAMPAIGNS_BUMP_CONTACTS_2000_MONTHLY` | `keel.campaigns.bump.contacts_2000.monthly` |
| +10,000 contacts | £29 / mo | `STRIPE_PRICE_CAMPAIGNS_BUMP_CONTACTS_10000_MONTHLY` | `keel.campaigns.bump.contacts_10000.monthly` |
| +50,000 contacts | £99 / mo | `STRIPE_PRICE_CAMPAIGNS_BUMP_CONTACTS_50000_MONTHLY` | `keel.campaigns.bump.contacts_50000.monthly` |
...
STRIPE_PRICE_ADDON_CAMPAIGNS_SCALE_MONTHLY=price_...
...
STRIPE_PRICE_CAMPAIGNS_PACK_SEND_200K=price_...
STRIPE_PRICE_CAMPAIGNS_PACK_SEND_200K_MONTHLY=price_...
STRIPE_PRICE_CAMPAIGNS_PACK_SEND_500K=price_...
STRIPE_PRICE_CAMPAIGNS_PACK_SEND_500K_MONTHLY=price_...
STRIPE_PRICE_CAMPAIGNS_BUMP_CONTACTS_500_MONTHLY=price_...
STRIPE_PRICE_CAMPAIGNS_BUMP_CONTACTS_2500_MONTHLY=price_...
STRIPE_PRICE_CAMPAIGNS_BUMP_CONTACTS_2000_MONTHLY=price_...
STRIPE_PRICE_CAMPAIGNS_BUMP_CONTACTS_10000_MONTHLY=price_...
STRIPE_PRICE_CAMPAIGNS_BUMP_CONTACTS_50000_MONTHLY=price_...
```
