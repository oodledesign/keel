  ...
  return (
    ...
    >
      <div
        className={cn(
          'absolute inset-0',
          isCard ? 'origin-top scale-[0.92]' : 'p-1 md:p-2',
        )}
      >
        ...
        {[
          ...
          >
            ...
            <div className="min-w-0">
              <p className="font-mono text-[10px] text-[var(--ozer-text-on-light-muted)]">
                {row.time}
              </p>
              <p
                className={cn(
  ...
  return (
    <div className="flex h-full flex-col rounded-[1.25rem] border border-[color:var(--workspace-shell-border)] bg-[var(--ozer-plum-950)] p-4">
      <div className="flex items-center gap-2">
        ...
        <p
          className={cn(
            'font-semibold text-[var(--ozer-text-on-dark)]',
      ...
      <div className="mt-3 space-y-2">
        {[
          ...
          >
            <p className="text-[10px] font-semibold text-[var(--ozer-lime-400)]">
              {row.client}
            </p>
            <p
              className={cn(
                'text-[var(--ozer-text-on-dark)]/90',
                compact ? 'text-[11px]' : 'text-xs',
              )}
            >
              {row.subject}
    ...
    <div className="flex h-full flex-col rounded-[1.25rem] border border-[color:var(--workspace-shell-border)] bg-[var(--ozer-plum-950)] p-4">
      ...
      <div className="mt-3 grid flex-1 gap-2 md:grid-cols-2">
        <div className="space-y-1.5">
          <p className="text-[9px] font-semibold tracking-wide text-[var(--ozer-coral-400)]/70 uppercase">
            Transcript
          </p>
          {[
            ...
            >
              <p className="text-[9px] font-semibold text-[var(--ozer-coral-400)]/80">
                {line.speaker}
              </p>
              <p className="truncate text-[10px] text-[var(--ozer-text-on-dark)]/85">
                {line.text}
              </p>
            </div>
          ))}
        ...
        <div className="space-y-1.5">
          <p className="text-[9px] font-semibold tracking-wide text-[var(--ozer-lime-400)] uppercase">
            Tasks
          </p>
          {[
            ...
            >
              ...
              <p className="text-[10px] leading-snug text-[var(--ozer-text-on-dark)]">
                {task}
              </p>
            </div>
          ))}
  ...
  return (
    <div className="flex h-full flex-col rounded-[1.25rem] border border-[color:var(--workspace-shell-border)] bg-[var(--ozer-plum-900)] p-4">
      ...
      <div className="mt-3 flex-1 rounded-xl border border-[color:var(--ozer-border-on-dark)] bg-[var(--ozer-plum-800)] p-3">
        <p className="text-[10px] text-[var(--ozer-text-on-dark-muted)]">
          Speaking into any app…
        </p>
        <p
          className={cn(
            'mt-2 leading-relaxed text-[var(--ozer-text-on-dark)]/95',
            compact ? 'text-[11px]' : 'text-xs',
          )}
        >
          Hi Sarah — thanks for the brief. I&apos;ll send the updated proposal
          by Friday with the portal mockups included.
        </p>
      </div>
    ...
    <div className="flex h-full flex-col rounded-[1.25rem] border border-[color:var(--workspace-shell-border)] bg-[var(--ozer-plum-950)] p-4">
      ...
      <div className="mt-2 flex gap-2">
        <div className="flex-1 rounded-lg border border-[color:var(--workspace-shell-border)] bg-[var(--workspace-shell-sidebar-accent)] px-2 py-1.5">
          <p className="text-[9px] text-[var(--ozer-text-on-dark-muted)]">
            Today
          </p>
          <p className="text-[11px] font-semibold text-[var(--ozer-text-on-dark)]">
            2h 18m
          </p>
        </div>
        <div className="flex-1 rounded-lg border border-[color:var(--workspace-shell-border)] bg-[var(--workspace-shell-sidebar-accent)] px-2 py-1.5">
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              <div className="flex items-center gap-1.5">
                <p
                  className={cn(
                    'truncate font-medium text-[var(--ozer-text-on-dark)]',
  ...
  return (
    <div className="flex h-full flex-col rounded-[1.25rem] bg-[var(--ozer-sky-100)] p-4 text-[var(--ozer-text-on-light)]">
      ...
      <div className="mt-3 grid flex-1 grid-cols-2 gap-2">
        {['Brand guidelines.pdf', 'Homepage v3', 'Invoice #1042'].map(
          (item) => (
            <div
              key={item}
            ...
            >
              ...
              <p className="mt-1 text-[9px] text-[var(--ozer-slate-blue)]/70">
                Ready for review
              </p>
            </div>
          ),
        ...
        <div className="rounded-xl border border-[color:var(--ozer-border-on-light)] bg-[var(--ozer-sage-100)] px-2.5 py-2">
          ...
          <p className="mt-1 text-[10px] font-medium text-[var(--ozer-plum-900)]">
            Synced with project
          </p>
        </div>
      </div>
  ...
  return (
    <div className="flex h-full flex-col rounded-[1.25rem] bg-[var(--ozer-sage-100)] p-4 text-[var(--ozer-text-on-light)]">
      ...
      <div className="mt-3 rounded-xl bg-[var(--ozer-white)] p-3">
        ...
        <p className="mt-2 text-[10px] text-[var(--ozer-text-on-light-muted)]">
  ...
  return (
    <div className="flex h-full flex-col rounded-[1.25rem] border border-[color:var(--workspace-shell-border)] bg-[var(--ozer-plum-950)] p-4">
      ...
      <div className="mt-2 flex-1 rounded-xl border border-[color:var(--ozer-border-on-dark)] bg-[var(--ozer-plum-800)] p-3">
        <p
          className={cn(
            'leading-relaxed text-[var(--ozer-text-on-dark)]/90',
            compact ? 'text-[10px]' : 'text-[11px]',
          )}
        >
          Launch is{' '}
          ...
          — from kickoff transcript and follow-up email.
        </p>
      </div>
    </div>
  );
    ...
    <div className="flex h-full flex-col rounded-[1.25rem] border border-[color:var(--workspace-shell-border)] bg-[var(--ozer-plum-950)] p-4">
      ...
      <div className="mt-3 space-y-2">
        <div className="ml-6 rounded-xl rounded-tr-sm bg-[var(--ozer-accent-subtle)] px-3 py-2">
          <p className="text-[10px] text-[var(--ozer-text-on-dark)]/90">
            Portal looks great — approve v3?
          </p>
        </div>
        <div className="mr-6 rounded-xl rounded-tl-sm bg-[var(--ozer-plum-800)] px-3 py-2">
          <p className="text-[10px] text-[var(--workspace-shell-text)]/80">
            Approved. Please send the invoice.
          </p>
        </div>
      </div>
      <p className="mt-auto text-[9px] text-[var(--ozer-text-on-dark-muted)]">
        Thread saved to project record
      </p>
    </div>
  );
}
  ...
  return (
    <div className="flex h-full flex-col rounded-[1.25rem] bg-[var(--ozer-coral-50)] p-4 text-[var(--ozer-text-on-light)]">
      ...
      <div className="mt-3 flex-1 rounded-xl bg-[var(--ozer-white)] p-3">
        ...
        <ul
          className={cn(
            'mt-2 space-y-1 text-[var(--ozer-text-on-light)]',
            compact ? 'text-[10px]' : 'text-xs',
          )}
        >
    ...
    <div className="flex h-full flex-col rounded-[1.25rem] bg-[var(--ozer-sky-100)] p-4 text-[var(--ozer-text-on-light)]">
      ...
      <div className="mt-3 grid flex-1 grid-cols-3 gap-2">
        {[
          ...
          <div
            key={col.label}
            className="rounded-xl bg-[var(--ozer-white)] p-2"
          >
            <p className="text-[10px] font-semibold text-[var(--ozer-text-on-light-muted)]">
              {col.label}
            </p>
    ...
    <div className="flex h-full flex-col rounded-[1.25rem] border border-[color:var(--workspace-shell-border)] bg-[var(--ozer-plum-950)] p-4">
      ...
      <div className="mt-3 space-y-2">
        {[
          ...
          <div
            key={row.name}
            className="rounded-xl border border-[color:var(--workspace-shell-border)] bg-[var(--workspace-shell-sidebar-accent)] p-2.5"
          >
            <div className="flex items-center justify-between gap-2">
              <p
                className={cn(
                  'truncate font-medium text-[var(--workspace-shell-text)]/90',
                  compact ? 'text-[10px]' : 'text-xs',
                )}
              >
                {row.name}
        ...
        {[
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              <p
                className={cn(
                  'truncate text-[var(--workspace-shell-text)]/85',
                  compact ? 'text-[10px]' : 'text-[11px]',
                )}
              >
                {row.title}
            ...
            {row.urgent ? (
              <span className="text-[9px] text-[var(--ozer-accent)]">
                Urgent
              </span>
            ) : null}
          </div>
    ...
    <div className="flex h-full flex-col rounded-[1.25rem] bg-[var(--ozer-sage-100)] p-4 text-[var(--ozer-text-on-light)]">
      ...
      <div className="mt-3 space-y-2">
        {[
          ...
          {
            title: 'North Lane retainer',
            status: 'Sent',
            tone: 'text-[var(--ozer-plum-900)] bg-[var(--ozer-coral-100)]',
          },
        ].map((row) => (
          <div
            key={row.title}
    ...
    <div className="flex h-full flex-col rounded-[1.25rem] border border-[color:var(--workspace-shell-border)] bg-[var(--ozer-plum-950)] p-4">
      ...
      <div className="mt-3 space-y-1.5">
        {[
          ...
          <div
            key={row.step}
            className="flex items-center gap-2 rounded-lg bg-[var(--workspace-shell-sidebar-accent)] px-2 py-1.5"
          >
            {row.done ? (
      ...
      <p className="mt-2 text-[9px] text-[var(--workspace-shell-text-muted)]">
        2 of 3 complete
      </p>
    </div>
  );
    ...
    <div className="flex h-full flex-col rounded-[1.25rem] border border-[color:var(--ozer-border-on-dark)] bg-[var(--ozer-plum-950)] p-4">
      ...
      <div className="mt-3 grid grid-cols-2 gap-2">
        <div className="rounded-xl border border-[color:var(--ozer-border-on-dark)] bg-[var(--ozer-plum-800)] p-2.5">
          ...
          <p
            className={cn(
              'font-bold text-[var(--ozer-text-on-dark)]',
        ...
        <div className="rounded-xl border border-[color:var(--ozer-border-on-dark)] bg-[var(--ozer-plum-800)] p-2.5">
          ...
          <p
            className={cn(
              'font-bold text-[var(--ozer-coral-400)]',
              compact ? 'text-lg' : 'text-xl',
            )}
          >
            £1.4k
