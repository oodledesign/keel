    ...
    <main className="marketing-shell relative overflow-hidden">
            ...
            return (
              ...
              >
                ...
                <p className="mt-4 text-3xl font-bold tracking-tight text-[var(--workspace-shell-text)]">
                  ...
                  {plan.priceGbp > 0 ? (
                    <span
                      className={`text-base font-normal ${marketingMutedText}`}
                    >
                      /mo
                    </span>
                  ) : null}
      ...
      <section className="relative mx-auto w-full max-w-7xl px-6 py-20">
        ...
        <p className={`mt-2 max-w-2xl text-sm ${marketingMutedText}`}>
          Add business, property, or community spaces anytime. Your personal
          home keeps tasks, planner, and shortcuts unified across every
          workspace.
        </p>
        ...
        <div
          className={cn(
            'mt-16 rounded-2xl border border-[color:var(--workspace-shell-border)] px-8 py-12 text-center',
            marketingFeatureCard,
          )}
        >
