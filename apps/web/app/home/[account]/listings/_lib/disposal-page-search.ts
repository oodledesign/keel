...
export const DISPOSAL_PAGE_SEARCH_INDEX: DisposalSearchHit[] = [
  ...
  // Marketing
  {
    ...
    href: '/marketing',
    title: 'Marketing',
    keywords: ['copy', 'particulars', 'summary'],
  },
  {
  ...
  {
    id: 'marketing-price-display',
    page: 'Marketing',
    href: '/marketing',
    hash: 'price-display',
    title: 'Price display',
    context: 'Hide rent / price as POA',
    keywords: ['poa', 'hide rent', 'hide price', 'on application'],
  },
  ...
  {
    id: 'media-private-images',
    page: 'Media',
    href: '/media',
    hash: 'private-images',
    title: 'Private images',
    context: 'Media',
    keywords: ['private', 'confidential', 'internal photos', 'internal images'],
  },
  {
    id: 'media-floorplans',
    page: 'Media',
  ...
  },
  {
    ...
    hash: 'assignment',
    title: 'Agents',
    context: 'Acting agents and co-agents',
    keywords: ['acting agent', 'contact', 'phone', 'team', 'co-agent'],
  },
  {
  ...
  {
    id: 'management-landlord-share',
    page: 'Management',
    href: '/management',
    hash: 'landlord-share',
    title: 'Landlord share',
    context: 'Management',
    keywords: ['landlord', 'share link', 'interest schedule'],
  },
  ...
  // Publishing
  {
    ...
    context: 'Channels',
    keywords: ['rightmove', 'portal', 'publish', 'marketplace', 'each'],
  },
  {
    id: 'publishing',
    page: 'Publishing',
  ...
  },
  {
    ...
    title: 'Marketing readiness',
    context: 'Publishing',
    keywords: ['checklist', 'ready', 'publish', 'epc'],
  },
  {
    ...
    hash: 'channels',
    title: 'Channels',
    context: 'Website, EACH, Rightmove',
    keywords: [
      'website',
      'each',
      'rightmove',
  ...
  {
    id: 'publishing-brochure',
    page: 'Publishing',
    href: '/publishing',
    hash: 'brochure',
    title: 'Brochure',
    context: 'Slideshow share and PDF',
    keywords: ['brochure', 'pdf', 'slideshow', 'share'],
  },
  {
    id: 'publishing-linkedin',
    page: 'Publishing',
    href: '/publishing',
    hash: 'linkedin',
    title: 'LinkedIn',
    context: 'Company page post',
    keywords: ['linkedin', 'social', 'post'],
  },
