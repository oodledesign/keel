...
export default async function SignaturesConnectSuccessPage({
  ...
  return (
    <main className="mx-auto flex min-h-svh max-w-lg flex-col justify-center px-4 py-16 text-[var(--workspace-shell-text)]">
      <div className="rounded-2xl border border-[var(--ozer-accent)]/30 bg-[var(--ozer-surface-panel)] p-8 text-center shadow-[0_1px_2px_rgba(42,23,32,0.04),0_3px_10px_rgba(42,23,32,0.05)]">
        ...
        <p className="mt-6 text-xs text-[var(--workspace-shell-text-muted)]">
