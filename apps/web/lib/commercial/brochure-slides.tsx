...
export type BrochureSlideViewProps = {
  data: PublicBrochureData;
  slide: BrochureSlide;
};

export function brochureFadeProps(reduced: boolean, delay = 0) {
  return {
    ...
    <div className="relative flex h-full w-full items-end overflow-hidden">
      ...
      <div className="relative z-10 w-full px-6 pt-10 pb-24 sm:px-10 sm:pb-28 md:px-16">
        <motion.p
          ...
          {...brochureFadeProps(reduced, 0.05)}
        >
        ...
        {address ? (
          <motion.p
            ...
            {...brochureFadeProps(reduced, 0.16)}
          >
            {address}
          </motion.p>
        ) : null}
