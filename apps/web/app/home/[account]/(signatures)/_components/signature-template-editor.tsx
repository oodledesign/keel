    ...
    <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_minmax(420px,0.9fr)]">
      <Card className="border-[color:var(--workspace-shell-border)] bg-[var(--workspace-shell-panel)] text-[var(--workspace-shell-text)]">
        ...
        <CardContent className="space-y-5">
                ...
                <div className="flex flex-wrap gap-2">
                  {SIGNATURE_TEMPLATE_TOKENS.map((token) => (
                    <button
                      ...
                      className="rounded-full border border-[color:var(--workspace-shell-border)] bg-[var(--workspace-shell-panel)] px-3 py-1 font-mono text-xs font-medium text-[var(--workspace-shell-text)] transition hover:border-[color:var(--ozer-info)] hover:bg-[var(--workspace-shell-sidebar-accent)]"
                    >
                      {'{{'}
                      {token}
                      {'}}'}
          ...
          <Collapsible
            open={darkModeOpen}
            onOpenChange={setDarkModeOpen}
            className="rounded-2xl border border-[color:var(--workspace-shell-border)] bg-[var(--workspace-shell-sidebar-accent)]"
          >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <ChevronDown
                      className={cn(
                        ...
                        darkModeOpen && 'rotate-180',
                      )}
                      aria-hidden
                    />
                  </div>
                  <p className="mt-1 text-xs text-[var(--workspace-shell-text-muted)]">
                    Soft checks only — saving is never blocked.
                  </p>
                </div>
            ...
            <CollapsibleContent className="space-y-3 px-4 pb-4">
              <p className="text-xs text-[var(--workspace-shell-text-muted)]">
                Fix warnings before publishing to staff inboxes.
              </p>
