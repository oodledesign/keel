      ...
      {step === 'plan' ? (
        <div className="space-y-6" data-test="business-signup-plan-step">
          ...
          <div className="space-y-2">
            <Label htmlFor="business-signup-seats">Billable seats</Label>
            <div className="flex items-center gap-3">
              <input
                id="business-signup-seats-range"
                type="range"
                min={1}
                max={30}
                value={billable}
                ...
                onChange={(event) =>
                  setSeats(
                    Math.min(
                      30,
                      clampBillableSeats(Number(event.target.value)),
                    ),
                  )
                }
              />
              <Input
                id="business-signup-seats"
                type="number"
                min={1}
                max={30}
                value={billable}
