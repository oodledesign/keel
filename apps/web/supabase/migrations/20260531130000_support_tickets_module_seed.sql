-- Add support_tickets module to work workspace seed list.
...
BEGIN
  ...
  ELSE
    keys := ARRAY[
      ...
      'websites', 'support_tickets', 'invoices', 'team', 'notes', 'docs',
      'finances', 'apps', 'feedflow', 'rankly', 'signatures', 'settings'
    ];
  END IF;
