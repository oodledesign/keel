-- Fix accept_invitation: parameter name "user_id" clashes with column refs in
-- ON CONFLICT (user_id) when copying invitee first/last names onto user_settings.
-- Keep the parameter name (callers / generated types use user_id) and resolve
-- conflicts via named constraints instead.
