...
import { ProjectStatusSlugSchema } from './project-statuses.schema';

const jobStatus = ProjectStatusSlugSchema;
...
export const CreateJobSchema = z.object({
  ...
  is_phased: z.boolean().optional().default(false),
