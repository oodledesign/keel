...
export const workspaceSidebarClassName = [
  'bg-[var(--workspace-shell-sidebar)] text-[var(--workspace-shell-text)]',
  '[--sidebar-background:var(--workspace-shell-sidebar)]',
  '[--sidebar-foreground:var(--workspace-shell-nav-text)]',
  '[--sidebar-accent:var(--workspace-shell-sidebar-accent)]',
  '[--sidebar-accent-foreground:var(--workspace-shell-nav-text-hover)]',
  '[--sidebar-border:var(--workspace-shell-border)]',
  '[--sidebar-width:15rem]',
  '[&_[data-sidebar=sidebar]]:bg-[var(--workspace-shell-sidebar)]',
  '[&_[data-sidebar=sidebar]]:text-[var(--workspace-shell-text)]',
  '[&_[data-sidebar=sidebar]]:border-r',
  '[&_[data-sidebar=sidebar]]:border-[var(--workspace-shell-border)]',
  '[&_[data-sidebar=group-label]]:px-3',
  '[&_[data-sidebar=group-label]]:pt-3',
  '[&_[data-sidebar=group-label]]:pb-1',
  '[&_[data-sidebar=group-label]]:text-[11px]',
  '[&_[data-sidebar=group-label]]:font-semibold',
  '[&_[data-sidebar=group-label]]:uppercase',
  '[&_[data-sidebar=group-label]]:tracking-wider',
  '[&_[data-sidebar=group-label]]:text-[var(--workspace-shell-nav-text)]',
  '[&_[data-sidebar=group-label]]:opacity-55',
  '[&_[data-sidebar=group]+[data-sidebar=group]]:mt-3',
  ...
  '[&_[data-sidebar=menu-button]]:text-[var(--workspace-shell-nav-text)]',
