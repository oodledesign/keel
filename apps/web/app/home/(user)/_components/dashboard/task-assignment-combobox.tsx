...
type TaskAssignmentComboboxProps = {
  ...
  placeholder?: string;
  /** Render only the searchable list (for embedding inside another popover). */
  embedded?: boolean;
  /** Override label for the unassigned option. */
  noneLabel?: string;
};
          ...
          >
            {group.projects.map((project) => (
              <CommandItem
                ...
                onSelect={() => selectOption(project.id)}
                className="text-[var(--workspace-shell-text)] aria-selected:bg-[var(--workspace-shell-sidebar-accent)] aria-selected:text-[var(--workspace-shell-text)]"
              >
                <Check
                  className={cn(
            ...
            <CommandGroup heading="Clients">
              {clients.map((client) => (
                <CommandItem
                  ...
                  onSelect={() => selectOption(client.id)}
                  className="text-[var(--workspace-shell-text)] aria-selected:bg-[var(--workspace-shell-sidebar-accent)] aria-selected:text-[var(--workspace-shell-text)]"
                >
                  <Check
                    className={cn(
