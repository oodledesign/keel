const swatches = [
  ...
  {
    name: 'Panel hover',
    token: '--ozer-surface-panel-hover',
    value: '#3D2A33',
  },
  ...
  {
    name: 'Active gradient from',
    token: '--ozer-gradient-active-from',
    value: '#C2452A',
  },
  {
    name: 'Active gradient to',
    token: '--ozer-gradient-active-to',
    value: '#FF5C34',
  },
];
      ...
      <section className="space-y-4">
        ...
        <div className="rounded-xl border p-6">
          <p className="text-muted-foreground text-sm">
            Primary actions use{' '}
            <code className="text-xs">ozer-gradient-btn</code> (alias{' '}
