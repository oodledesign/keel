-- Register instagram_autoreply module in workspace seed + Oodle Design.

DROP FUNCTION IF EXISTS public.seed_account_module_settings(uuid, text, text);
...
INSERT INTO public.account_module_settings (account_id, module_key, enabled)
VALUES ('c38690a8-3573-4624-943a-63e14cc8dbce', 'instagram_autoreply', true)
ON CONFLICT (account_id, module_key) DO NOTHING;
